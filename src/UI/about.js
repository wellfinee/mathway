const AboutUS = () => {
  return(
    ...
    <div class="about">  <div class="big-t-a"><span>О нас</span></div>Contrary to popular belief, Lorem Ipsum is not simply random text.
...
Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H.
 Rackham.</div>
    </div>
  )
}
